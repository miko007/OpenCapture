...
if ( ! function_exists( 'sds_post_meta' ) ) {
	function sds_post_meta() {
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was posted in %1$s and tagged in %2$s.', 'capture' ),
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was posted in %1$s.', 'capture' ),
				get_the_category_list( ', ', 'single' ) );
			?>
			</p>
		<?php
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was tagged in %1$s.', 'capture' ),
				get_the_tag_list( '', ', ' ) );
			?>
			</p>
		<?php
...
if ( ! function_exists( 'sds_comment' ) ) {
	function sds_comment( $comment, $args, $depth ) {
		...
		<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
			<p><?php _e( 'Pingback:', 'capture' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( 'Edit', '<span class="ping-meta"><span class="edit-link">', '</span></span>' ); ?></p>
		</li>
		<?php
			break;
			default :
			...
			<article id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
							...
							<cite class="fn">
								<?php
									printf( __( '<a href="%1$s"><time datetime="%2$s" itemprop="commentTime">%3$s</time></a>', 'capture' ),
										...
										get_comment_time( 'c' ),
										sprintf( __( '%1$s at %2$s', 'capture' ), get_comment_date(), get_comment_time() )
									);
								?>

								<?php edit_comment_link( __( 'Edit', 'capture' ), '<span class="edit-link">', '<span>' ); ?>
							</cite>
						</header>
					</section>
				</section>
				...
				<section class="comment-content-container">
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'capture' ); ?></p>
					<?php endif; ?>
				...
				<section class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'capture' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</section>
			</article>
		</li>
		<?php
...
function sds_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Logo/Site Title & Tagline', 'capture' );
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'content_color',
			array(
				'label'  => __( 'Content Color', 'capture' ),
				'section' => 'colors',
...
function sds_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Primary Sidebar', 'capture' ),
		'id'            => 'primary-sidebar',
		'description'   => __( 'This widget area is the primary widget area.', 'capture' ),
	...
	register_sidebar( array(
		...
		'description'   => __( 'This widget area is the secondary widget area.', 'capture' ),
	...
	register_sidebar( array(
		...
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings > Reading in the Dashboard.* This widget area is displayed above the content on the Front Page.', 'capture' ),
